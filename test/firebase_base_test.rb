...
class FirebaseBaseTest < ActiveSupport::TestCase
  ...
  def test_find_by_param
    _stock_1 = FirebaseStock.create(symbol: 'AAA')
  ...
  def test_find_by_boolean_param
    _stock_1 = FirebaseTransaction.create(open: false)
    _stock_2 = FirebaseTransaction.create(open: false)
    stock_3 = FirebaseTransaction.create(open: true)
    _stock_4 = FirebaseTransaction.create(open: false)
  ...
  def test_find_by_multiple_params
    _stock_1 = FirebaseStock.create(symbol: 'AAA', price: 3.44)
    stock_2 = FirebaseStock.create(symbol: 'BBB', price: 1.22)
    _stock_3 = FirebaseStock.create(symbol: 'BBB', price: 1.33)
  ...
  def test_has_many_associations_return_array_of_ids
    ...
    assert stock.transactions.is_a?(Array)
  end
  ...
  def test_has_many_associations_with_just_ids
    ...
    stock.set_transactions(transactions.map(&:id))
    assert_equal 3, stock.transactions.count
  end
